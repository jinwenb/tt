module.exports = {
  ...
  onLoad: function(t, e) {
    ...
    if (this.setUserInfo(), this.setWxappImg(), this.setStore(), this.setParentId(e),
      ...
      if (e.user_id) var n = e.user_id,
        a = e.id;
      else if (e.scene && isNaN(e.scene)) {
  ...
  onShow: function(e) {
    ...
    if (this.currentPage = e, t.onShowData && t.onShowData.scene) {
      ...
      0 <= o.indexOf(t.onShowData.scene) ? this.setPageNavbar() : (console.log("no in array--\x3e", t.onShowData.scene),
  ...
  setDeviceInfo: function() {
    ...
    if (o.model)
      for (var n in 0 <= o.model.indexOf("iPhone X") && (o.model = "iPhone X"),
  ...
  setPageNavbar: function() {
    ...
    e && n(e);
    var t = !1;
    for (var o in r.navbarPages)
      if (s.route == r.navbarPages[o]) {
        t = !0;
        break;
      }
  ...
  setNavigationBarColor: function() {
    var t = this.currentPage,
      e = getApp().core.getStorageSync(getApp().const.NAVIGATION_BAR_COLOR);
  ...
  _setFormIdSubmit: function(e) {
    ...
    g._formIdSubmit || (g._formIdSubmit = function(e) {
      ...
      var t = e.currentTarget.dataset,
        ...
        r = t.appId || null,
        v = t.sdds,
        s = getApp().core.getStorageSync(getApp().const.FORM_ID_LIST);
      ...
      switch (
        console.log("form_id"), 
        "the formId is a mock one" === o || getApp().helper.inArray(o, c) || (s.push({
  ...
  myLogin: function() {
    ...
    "my" === getApp().platform
     ...
     (
       console.log(
         getApp().login_complete
         ),
        getApp().login_complete || (getApp().login_complete = !0,
  ...
  unionLogin: function(e) {
    var o = this.currentPage,
      n = this;
    console.log(e);
    //023mEJWC0QhYCk2xQ6VC0ycmWC0mEJWo
