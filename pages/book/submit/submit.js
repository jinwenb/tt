...
Page({
  ...
  submit: function(t) {
    var e = t.detail.formId,
      a = this.data.goods.id,
      o = JSON.stringify(this.data.attr),
      i = JSON.stringify(this.data.form_list),
      s = this.data.pay_type;
    getApp().core.showLoading({
      title: "正在提交",
      mask: !0
    }), getApp().request({
